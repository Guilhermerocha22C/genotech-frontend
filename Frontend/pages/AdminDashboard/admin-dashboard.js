...
async function fetchUsers() {
    try {
        const response = await fetch('genotechfullstack.vercel.app/api/admin/users');
...
async function editUser(userId, userName, userEmail) {
    ...
    if (formValues) {
        ...
        try {
            const response = await fetch(`genotechfullstack.vercel.app/${userId}`, {
                method: 'PUT',
                headers: {
...
async function deleteUser(userId) {
    ...
    if (result.isConfirmed) {
        try {
            const response = await fetch(`genotechfullstack.vercel.app/api/admin/users/${userId}`, {
                method: 'DELETE'
            });
