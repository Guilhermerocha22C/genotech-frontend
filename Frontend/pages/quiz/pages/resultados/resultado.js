...
async function atualizarUsuario(acertos, xpIncremento) {
    try {
        ...
        const response = await fetch('https://genotech-backend.vercel.app/api/atualizar-usuario', {
            method: 'POST',
            headers: {
...
async function exibirRanking() {
    try {
        ...
        const response = await fetch('https://genotech-backend.vercel.app/api/ranking');
